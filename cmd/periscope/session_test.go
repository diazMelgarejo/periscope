...
import (
	...
	agentsync "github.com/latentsignal-org/periscope/internal/sync"
...
func TestSessionList_PGFlagUsesPGReadStore(t *testing.T) {
	...
	remoteDir := t.TempDir()
	t.Setenv("AGENTSVIEW_PG_URL", "postgres://example.test/periscope")
	...
	assert.Equal(t, "postgres://example.test/periscope", stub.PG.URL)
